    ...
    <div class="container" style="padding: 20px;">
        ...
        @if(count($cart) > 0)
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                @foreach($cart as $id => $item)
                    ...
                    <div
                        ...
                        <div style="flex: 1;">
                            ...
                            <p style="margin: 0; color: #6c757d;">{{ Str::limit($item['name'], 50) }}</p>
                            <p style="margin: 5px 0 0 0; color: #0d6efd; font-weight: bold;">{{ number_format($item['price'], 2) }}
                                €</p>
                        </div>
                ...
                <form action="{{ route('cart.destroy') }}" method="POST" style="margin: 0;">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                            style="background-color: orangered; color: white; padding: 4px 8px; border-radius: 5px; border: none; cursor: pointer;"
        ...
        @else
            <div
                ...
                <h4>Panier vide :'(</h4>
                <a href="{{ route('products.index') }}"
                   style="display: inline-block; margin-top: 10px; background-color: limegreen; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">
